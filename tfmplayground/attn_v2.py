...
# MZ: commented out to avoid importing from tabPFN
# from tabpfn.architectures.base.attention import Attention

# MZ: Disable the saved_peak_mem_factor decorator
# from tabpfn.architectures.base.memory import support_save_peak_mem_factor

# MZ: commented out to avoid importing from tabPFN, use a nanoPFN ModelConfig instead
# if TYPE_CHECKING:
